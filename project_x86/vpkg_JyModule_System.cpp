...
INT CALLBACK rg_j_jt::rg_n9708 (rg_hsh_jb::rg_wbshzl& rg_n9709)
{
    CVolString rg_n9710;
    if (DWORD dwDriveStrings = GetLogicalDriveStringsW(0, NULL))
    {
        ...
        {
            rg_n9710.SetValueText(szDriveStrings + i);
    rg_n9709.data ().Add2 (rg_n9710.Left (1).GetText ());
            i += wcslen(szDriveStrings) + 1;
        }
        delete[] szDriveStrings;
    }
    return ((INT)rg_n9709.data ().GetCount ());
}
