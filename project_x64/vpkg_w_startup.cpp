...
int gCallStartupMethod ()
{
    if (IsDebuggerPresent () == FALSE)
    {
        try
        {
            return ((rg_hsh_chx::rg_qdl&)g_objVolApp.GetVolApp ()).rg_n1 ();
        }
...
int APIENTRY _tWinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
    ...
    {
        if (pobjWinApp == NULL ||
                pobjWinApp->rg_n5725 ((INT_P)msg.hwnd, (INT)msg.message,
...
BOOL rg_chkchxl::rg_n5725 (INT64 rg_n5726, INT rg_n5727, INT64 rg_n5728, INT64 rg_n5729, INT64 rg_n5730)
{
    return (TRUE);
}

BOOL rg_chkchxl::rg_n5731 (INT rg_n5732)
{
    return (FALSE);
}

void rg_chkchxl::rg_n5733 ()
{
}
